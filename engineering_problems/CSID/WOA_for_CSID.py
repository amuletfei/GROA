...
class WOA():
    ...
    def WOA_ReRun(self, Recount):
        ...
        np.savetxt('./CSIDResult/con_result/WOAcon_counter_{}.csv'.format('CSID'), avg_con, delimiter=",")
        np.savetxt('./CSIDResult/best_solution/WOA_best_solution_{}.csv'.format('CSID'), best_solutions, delimiter=",")
        np.savetxt('./CSIDResult/all_score/WOA_all_score_{}.csv'.format('CSID'), all_score, delimiter=",")
        c = avg_scorecount
        plt.figure()
        myfig=plt.gcf()
        ...
        myfig.savefig('./CSIDResult/Pic/WOA_CSID_f{}.png'.format(self.fun_num))
        # plt.show()
        plt.close('all')
...
def main():
    ...
    np.savetxt('./CSIDResult/avg_result/WOA_avg_{}.csv'.format('CSID'), c, delimiter=",")
    np.savetxt('./CSIDResult/total_result/WOA_total_{}.csv'.format('CSID'), b, delimiter=",")
